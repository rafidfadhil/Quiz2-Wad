<div class="modal fade" id="exampleModalchangestatus<?php echo $count1;?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select class="form-control" id="Status_Order<?php echo $count1;?>">
            ...
            <div class="modal-footer">
                <input name="" type="button" onclick="submitPass<?php echo $count1?>()"
                    class="btn btn-success form-control" value="order ">
            </div>
        </div>
    </div>
</div>
...
function submitPass<?php echo $count1?>() {
    ...
    $.ajax({
        url: "status-udate-ajax.php?Status=".concat(Status, "&CODE=".concat(CODE)),
