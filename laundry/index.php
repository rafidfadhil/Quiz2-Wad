...
<body>
    <ul id="social_side_links">
        <li><a style="background-color: #009688;width: 130px;height: auto;color: white;font-size: 29px"
                data-toggle="modal" data-target="#myModal1">Order Now</a></li>
  ...
  <a href="#" class="facebook" data-toggle="modal" data-target="#myModal1">Order Now<i class="fa fa-order"></i></a> 
    ...
    <div class="w3l_banner">
        ...
        <nav class="navbar navbar-default ">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <h1><a class="navbar-brand" href="#">MAGIC LAUNDRY</a></h1>
                </div>
        ...
        <div class="w3l_bandwn">
            <h2>Welcome to MAGIC LAUNDRY</h2>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">MAGIC LAUNDRY</h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <p>Jaringan kami masih terus berkembang. Saat ini, kami beroperasi di bidang utama
                                    ...
                                    Jangan khawatir. Milikmu
                                    pakaian akan berada di tangan tim yang berpengalaman dan profesional, khususnya
                                    dilatih untuk menangani cucian Anda dengan sangat hati-hati. Kami TIDAK PERNAH
                                    berkompromi pada kualitas. Aman
                                    dan deterjen ramah lingkungan serta produk dry-cleaning kualitas impor
                                    digunakan.

                                    Kami Pickup dan Kirim Pakaian di Depan Pintu Anda.

                                    Layanan kami tidak hanya cepat, bersih, efisien, tetapi juga sangat andal. Kita
                                    eksekutif layanan pelanggan dilatih secara khusus untuk memberikan panduan dan
                                    memastikan
        ...
        <div class="features" id="features">
            <div class="container">
                ...
                <div class="tittle_head_w3layouts">
                    ...
                    <P>Layanan kami tidak hanya cepat, bersih, efisien, tetapi juga sangat andal. Eksekutif layanan
                        pelanggan kami dilatih secara khusus untuk memberikan panduan dan memastikan pengiriman tepat
                        waktu.</p>
                </div>
                <div class="inner_sec_info_agileits_w3">
                    ...
                    <div class="w3_banup">
                        ...
                        <div class="col-md-4 wthree_r">
                            ...
                            <div class="col-md-10 w3_txt">
                                <h4>Bedding</h4>
                                <p class="move">Layanan kami tidak hanya cepat, bersih, efisien, tetapi juga sangat
                                    andal. </p>
                            </div>
                            <div class="clearfix"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
                                        <a href="images/g1.jpg" class="thumbnail cm-overlay">
                                            <img src="images/g1.jpg" class="img-responsive" alt="Image"
                                                style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
                                        <a href="images/g2.jpg" class="thumbnail cm-overlay">
                                            <img src="images/g2.jpg" class="img-responsive" alt="Image"
                                                style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
                                        <a href="images/g3.jpg" class="thumbnail cm-overlay">
                                            <img src="images/g3.jpg" class="img-responsive" alt="Image"
                                                style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
                                        <a href="images/g4.jpg" class="thumbnail cm-overlay">
                                            <img src="images/g4.jpg" class="img-responsive" alt="Image"
                                                style="max-width:100%;">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
                                        <a href="images/g5.jpg" class="thumbnail cm-overlay">
                                            <img src="images/g5.jpg" class="img-responsive" alt="Image"
                                                style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
                                        <a href="images/g6.jpg" class="thumbnail cm-overlay">
                                            <img src="images/g6.jpg" class="img-responsive" alt="Image"
                                                style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
                                        <a href="images/g7.jpg" class="thumbnail cm-overlay">
                                            <img src="images/g7.jpg" class="img-responsive" alt="Image"
                                                style="max-width:100%;">
                                        </a>
                                    </div>
                                    <div class="col-md-3 col-sm-6 col-xs-6 img-gallery-w3l">
    ...
    $a++;
                ...
                <div class="agile_dwng">
                    <a href="#" data-toggle="modal"
                        data-target="#myModa<?php echo $a?>"><?php echo $row->Services_Name?></a>
                    <div class="modal video-modal fade" id="myModa<?php echo $a?>" tabindex="-1" role="dialog"
                        aria-labelledby="myModa<?php echo $a?>">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
