...
<div class=" register">
    <div class="row">
        <div class="col-md-3 register-left">
            ...
            <h3>Welcome to MAGIC LAUNDRY </h3>
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="any thing" class="form-control" required="" id="name"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" maxlength="12" minlength="12" required=""
                                id="phone" placeholder="Last Name *" value="" pattern="[0-9]{12}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" required="" id="P_date" placeholder="Last Name *"
                                value="" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" required="" id="D_date" placeholder="Last Name *"
                                value="" />
                        </div>
                    </div>
                    <div class="col-md-12">
                                ...
                                <?php $Show1=Serv_Type();
									                $count='0';
									                 while ($row=$Show1->fetch_object()) {
									                   $count++;
									                ?>
                                <option value="<?php echo $row->Services_Name ?>"><?php echo $row->Services_Name ?>
                                </option>
                                <?php };?>
...
function submit() {
    ...
    $.ajax({
        ...
        data: 'name=' + name + '&phone=' + phone + '&P_date=' + P_date + '&D_date=' + D_date + '&Address=' +
            Address + '&item=' + item + '&Type=' + Type + '&Dry=' + Dry + '&Laundry=' + Laundry +
